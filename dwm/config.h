...
static const char col_gray1[]      = "#040306";
static const char col_gray2[]      = "#dfdbe5";
static const char col_gray3[]      = "#dfdbe5";
static const char col_gray4[]      = "#040306";
static const char col_cyan[]       = "#d3679b";
...
static const char *screenshot_area[] = { "/usr/bin/scrot", "-s", "/home/florian/Pictures/screenshots/%Y-%m-%d-%T.png", "-q", "90", "-f", "-e", "xclip -selection clipboard -t image/png -i $f", NULL };
static const char *screenshot_wind[] = { "/usr/bin/scrot", "-u", "/home/florian/Pictures/screenshots/%Y-%m-%d-%T.png", "-q", "90", "-e", "xclip -selection clipboard -t image/png -i $f", NULL };
